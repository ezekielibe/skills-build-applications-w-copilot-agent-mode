...
class YourModelTestCase(TestCase):
    ...
    def test_model_creation(self):
        ...
        self.assertEqual(obj.field2, 'value2')  # Replace with actual fields to test

    def test_model_str(self):
        """Test the string representation of the model."""
        obj = YourModel.objects.get(field1='value1')
        self.assertEqual(str(obj), 'Expected String Representation')  # Replace with actual expected string representation